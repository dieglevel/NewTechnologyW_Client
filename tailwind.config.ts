...
export default {
	...
	content: [
		...
		"./node_modules/@heroui/theme/dist/components/(avatar|button|checkbox|date-input|date-picker|divider|dropdown|image|input|input-otp|link|modal|popover|radio|skeleton|spinner|tabs|toast|ripple|form|calendar|menu).js",
	],
	theme: {
		extend: {
			width: {

...
export default {
	...
	content: [
		...
		"./node_modules/@heroui/theme/dist/components/(avatar|button|checkbox|date-input|dropdown|image|input|input-otp|link|modal|popover|radio|skeleton|spinner|tabs|toast|ripple|form|menu|divider).js",
	],
	theme: {
		extend: {
			width: {

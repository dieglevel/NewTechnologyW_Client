...
export const AddGroupIcon = (props: SVGProps<SVGSVGElement>) => (
	...
	>
		...
		/>
		<path
			d="M18.3334 17.5001V15.8334C18.3328 15.0948 18.087 14.3774 17.6345 13.7937C17.182 13.2099 16.5485 12.793 15.8334 12.6084"
			strokeLinecap="round"
			strokeLinejoin="round"
			strokeWidth={1.5}
		/>
		...
		/>
		<path
			d="M17.5 8.3335V11.6668"
			strokeLinecap="round"
			strokeLinejoin="round"
			strokeWidth={1.5}
		/>
		<path
			d="M19.1667 10H15.8334"
			strokeLinecap="round"
			strokeLinejoin="round"
			strokeWidth={1.5}
		/>

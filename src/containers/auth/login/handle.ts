...
export const handleLogin = async (setIsLoading: Dispatch<SetStateAction<boolean>>,
   identifier: string,
   password: string,
   ...
   try {
      ...
      addToast({
         ...
         variant: "solid",
         title: "Đăng nhập thất bại",
         description: error.statusCode === 404 ? "Sai tài khoản hoặc mật khẩu" : "Có lỗi xảy ra, vui lòng thử lại sau",
         color: "danger",
      })
   }
   finally {
